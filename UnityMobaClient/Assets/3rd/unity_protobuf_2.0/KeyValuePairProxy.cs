...
//{
//    /// <summary>
//    /// Mutable version of the common tab/value pair struct; used during serialization. This type is intended for internal use only and should not
...
//        public TKey Key { get { return tab; } set { tab = value; } }
//        /// <summary>
//        /// The value of the pair.
//        /// </summary>
//        [ProtoMember(2)]
//        public TValue Value{ get { return value; } set { this.value = value; } }
//        private KeyValuePairSurrogate(TKey tab, TValue value)
//        {
//            this.tab = tab;
//            this.value = value;
//        }
...
//        {
//            return new KeyValuePair<TKey,TValue>(value.tab, value.value);
//        }
//        /// <summary>
